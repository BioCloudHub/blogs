---
title: 分析方法与质量标准：分辨率、HCP 去除与纯度控制
...
# 分析方法与质量标准：分辨率、HCP 去除与纯度控制

> 这一组内容把“分辨率、HCP 去除与纯度控制”下最值得优先掌握的问题收拢到一起，共整理 44 个知识点，按 2 个细分页面分层展开。
...
- **这组内容主要解决什么：** 这个主题聚焦分析方法与质量标准中与“分辨率、HCP 去除与纯度控制”相关的核心判断问题，重点不是背术语，而是把概念、场景和证据连起来。
