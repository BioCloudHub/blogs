...
> 当前专题共整理 225 个知识点、5 个二级主题、10 个细分页面，已经按“先理解问题，再进入判断，再补充证据”的逻辑重组。

这不是一组零散问答，而是一套围绕法规申报与审评策略搭起来的知识结构。建议先看下面的专题补充，再决定从哪个二级主题切入。

## 专题补充

:::answer

- **这个专题真正要解决什么：** 这个专题不是法规条文摘抄，而是把资料准备、技术表达、桥接逻辑和审评关注点串成一条真正能落地的申报路线。
- **项目里最常见的痛点：** 项目里最容易卡住的不是资料没写，而是证据和结论对不上、项目阶段判断失准、问题答复不够聚焦，导致越写越被动。
- **阅读时最该抓住什么：** 阅读时先区分 IND、BLA/NDA、变更和补充资料场景，再看模块边界、数据深度、风险表达和答复逻辑。
- **怎样把它用到项目里：** 如果你在做申报资料统稿、审评问答、变更策略或跨部门对齐，这个专题最适合和“分析方法与质量标准”“工艺表征、验证与统计设计”一起看。
